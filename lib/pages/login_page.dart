...
class _LoginPageState extends State<LoginPage> {
  ...
  Future<void> verificarConexao() async {
    ...
    setState(() {
      _semInternet = resultado.contains(ConnectivityResult.none);
    });
  }
                                ...
                                Padding(
                                  ...
                                  child: Container(
                                    ...
                                    decoration: BoxDecoration(
                                      color: AppColors
                                          .gray7, // Substitua pelo seu customColor11
    ...
    return Center(
      child: Padding(
        ...
        child: Column(
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
            Icon(Icons.wifi_off_rounded, size: 90, color: Colors.redAccent),
            ...
            const Text(
              'Conecte seu dispositivo à internet para acessar o CheckPoint.',
              textAlign: TextAlign.center,
